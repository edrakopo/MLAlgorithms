...
model.add(Dense(50, input_dim=2203, kernel_initializer='lecun_uniform', activation='softplus'))
model.add(Dense(15, kernel_initializer='lecun_uniform', activation='softplus'))
