#optimising parameters for Energy BDT
...
infile = "../../TrackLengthReconstruction/test_optCC0pi/vars_Ereco_train_06082019CC0pi.csv"
#----------------
...
print('initial train shape: ',arr3_hi_E.shape," arr2_hi_E_n.shape: ",arr2_hi_E_n.shape)
...
def optimise_model(model, alg_name, search_method, params):
    ...
    random_search.fit(arr2_hi_E_train, arr3_hi_E_train)
...
optimise_model(net_hi_E, " BDTG ", "grid", params)
#---------------------------#
