...
data = pd.read_csv("predictions_XGBoost_3percent.csv")
#data = pd.read_csv("XGBoost.csv")
print(data.head())
#print(data[:20])
#class_names = data["label"].values
class_names = data["newlabel"].values
print("class_names: ",class_names)
#class_types=["Atm Muons","Neutrinos"]
class_types=["Neutrinos", "Atm Muons"]
...
plot_confusion_matrix(data["newlabel"], data["Prediction"], classes=class_names,
...
plot_confusion_matrix(data["newlabel"], data["Prediction"], classes=class_names, normalize=True,
